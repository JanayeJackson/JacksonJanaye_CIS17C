...
int main(int argc, char** argv) {
    ...
    //Sort the array using bubble sort - record time
    beg = time(0);
    bublSrt(array,SIZE);
    end = time(0);
    bTime = end - beg;
    
    //sort the array using selection sort - record time
    beg = time(0);
    selSort(brray,SIZE);
    end = time(0);
    sTime = end-beg;
    ...
    //Display results
    cout<<"For N= "<<SIZE<<" Bubble sort takes "<<bTime<<" seconds"<<endl;
    cout<<"For N= "<<SIZE<<" Selection sort takes "<<sTime<<" seconds"<<endl;
    if(bTime < sTime)
        cout<<"Bubble sort is faster\n"<<endl;
    else
        cout<<"Selection sort is faster\n"<<endl;
