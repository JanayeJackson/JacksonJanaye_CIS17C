 ...
 *
 * Created on May 4th, 2024, 8:28 PM
 */
    ...
    do{
        if(bet == true){
            if(pMoney < 2){
                ...
                cout<<"Would you like to see your plays: (y or n)"<<endl; //show list of players plays
                cin>>choice;
                if(choice == 'y' || choice == 'Y')
                    showPlays(scores);
                break;
            ...
            bool accept = false;
            do{
                cout<<"How much would you like to bet: Minimum bet is $2"<<endl;
                cin>>bMoney;
                if(bMoney >= 2)
                    accept = true;
            }while(!accept);
        ...
        /*else if(temp1.face.compare(temp2.face) == 0) { //special case for if cards are the same face
        ...
        if(pTotal == 21){//check for win
            ...
            if(choice == 'y' || choice == 'Y'){//check if player still plays
                ...
                if(choice == 'y' || choice == 'Y')
                    showPlays(scores);
                cout<<"Would you like to see game stats: (y or n)"<<endl;
                cin>>choice;
                if(choice == 'y' || choice == 'Y')
                    stats(pMove, dMove);
                play = false;
            ...
            if(choice == 'y' || choice == 'Y'){//check if player still plays
                ...
                if(bet)
                    cout<<"You have $"<<pMoney<<endl; //show player's total amount of money
                cout<<"Would you like to see your plays: (y or n)"<<endl;
                cin>>choice;
                if(choice == 'y' || choice == 'Y')
                    showPlays(scores);
                cout<<"Would you like to see game stats: (y or n)"<<endl;
...
void stats(stack<card> player, stack<card> dealer){
    ...
    cout<<"/nList of player cards"<<endl;
    while(!player.empty()){
        temp = player.top();
        cout<<i<<". "<<temp.face<<" of "<<temp.suit<<endl;
        player.pop();
        i++;
    }
    //list all cards dealt to dealer
    i = 0;
    cout<<"/nList of dealer cards"<<endl;
    while(!dealer.empty()){
        temp = dealer.top();
        cout<<i<<". "<<temp.face<<" of "<<temp.suit<<endl;
        dealer.pop();
